  ...
  return (
    <div className="min-h-screen bg-[#050505] flex flex-col justify-center relative overflow-hidden text-white font-sans selection:bg-lime-500/30">
      ...
      <div className="absolute inset-0 z-0 opacity-20 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-[40vw] h-[40vw] bg-lime-500/20 rounded-full blur-[120px]" />
        <div className="absolute bottom-1/4 right-1/4 w-[30vw] h-[30vw] bg-fuchsia-600/20 rounded-full blur-[100px]" />
      </div>
          ...
          <div className="space-y-3 mb-8">
            <form action={signInWithDiscord}>
              ...
              >
                ...
                <span className="font-medium">Discord ile Giriş Yap</span>
              </button>
            </form>
